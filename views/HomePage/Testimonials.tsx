...
const TESTIMONIALS = [
  {
    ...
    content: `He is the best colleague I ever working with`,
    author: {
      name: 'Khoi Lam',
      title: 'Senior Frontend Engineer',
      avatarUrl: '/testimonials/author-photo-4.png',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-2.svg',
    content: `Son helped me so all the problems in the company`,
    author: {
      name: 'Tuyen Timmy',
      title: 'Middle Fullstack Developer',
      avatarUrl: '/testimonials/author-photo-5.png',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-3.svg',
    content: `What a brilliant man! He always feedback to me as soon as possible!`,
    author: {
      name: 'Amber Trivedi',
      title: 'Character Animator | Product Owner',
      avatarUrl: '/testimonials/author-photo-6.jpg',
    },
  },
  {
    companyLogoUrl: '/testimonials/company-logo-3.svg',
    content: `My Chelsea friend, you're awesome!`,
    author: {
      name: 'Mohammad Syed',
      title: 'Results-Driven Project Manager | Delivering Industry-Disrupting Solutions',
      avatarUrl: '/testimonials/author-photo-7.jpg',
    },
  },
];
